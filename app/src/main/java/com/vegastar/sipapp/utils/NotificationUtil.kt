...
import com.vegastar.sipapp.component.receiver.RejectCallActionReceiver
import com.vegastar.sipapp.ui.call.IncomingCallActivity
import com.vegastar.sipapp.utils.constant.KeyConstant.KEY_ACTION
import com.vegastar.sipapp.utils.constant.KeyConstant.KEY_CALL_REJECT
import com.vegastar.sipapp.utils.constant.KeyConstant.KEY_OBJECT
import com.vegastar.sipapp.utils.constant.KeyConstant.KEY_UUID
...
//    }
    ...
    fun createIncomingCallNotification(context: Context) {
        ...
        val builder: NotificationCompat.Builder = NotificationCompat.Builder(context, channelId)
            .setSmallIcon(R.mipmap.ic_launcher)
            .setLargeIcon(BitmapFactory.decodeResource(context.resources, R.mipmap.ic_launcher))
            .setColor(ContextCompat.getColor(context, R.color.colorAccent)) //.setCustomContentView(notificationView)
            //.setContentIntent(pendingIntent)
            //.setFullScreenIntent(pendingIntent, true)
