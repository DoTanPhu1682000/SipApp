...
import com.vegastar.sipapp.databinding.ActivityIncomingCallBkBinding
...
class IncomingCallBKActivity : AppCompatActivity() {
    private lateinit var core: Core
    private lateinit var binding: ActivityIncomingCallBkBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityIncomingCallBkBinding.inflate(layoutInflater)
