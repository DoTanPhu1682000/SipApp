...
public class StatusRelativeLayout extends RelativeLayout implements StatusLayout {
    ...
    public StatusRelativeLayout(Context context) throws MyException {
        super(context);
        mContext = context;
    }

    public StatusRelativeLayout(Context context, AttributeSet attrs) throws MyException {
        super(context, attrs);
        init(context, attrs);
    }

    public StatusRelativeLayout(Context context, AttributeSet attrs, int defStyle) throws MyException {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (background == 0)
            setLayoutBackground(ContextCompat.getColor(context, R.color.white));
    ...
    private void inflateLoadingLayout() {
        if (viewLoading == null) {
            ...
            addView(viewLoading, getChildCount(), layoutParams);
    ...
    private void inflateStatusLayout() {
        if (viewStatus == null) {
            ...
            addView(viewStatus, getChildCount(), layoutParams);
