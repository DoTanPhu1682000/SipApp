...
public class IconText extends BaseCustomView {
    ...
    public void init(final Context context, AttributeSet attrs) {
        ...
        if (inflater != null) {
            inflater.inflate(R.layout.custom_icon_text, this);
            ...
            if (attrs != null) {
                ...
                try {
                    String text = ta.getString(R.styleable.IconText_it_text);
                    ColorStateList textColor = ta.getColorStateList(R.styleable.IconText_it_textColor);
                    float textSize = ta.getDimension(R.styleable.IconText_it_textSize, -1);
                    int textGravity = ta.getInteger(R.styleable.IconText_it_textGravity, -1);
                    int textStyle = ta.getInteger(R.styleable.IconText_it_textStyle, -1);
                    mTextAllCaps = ta.getBoolean(R.styleable.IconText_it_textAllCaps, false);
                    ...
                    Drawable iconLeft = ta.getDrawable(R.styleable.IconText_it_iconLeft);
                    float iconLeftSize = ta.getDimension(R.styleable.IconText_it_iconLeftSize, -1);
                    setIconLeft(iconLeft);
                    setIconLeftSize(iconLeftSize);

                    Drawable iconRight = ta.getDrawable(R.styleable.IconText_it_iconRight);
                    float iconRightSize = ta.getDimension(R.styleable.IconText_it_iconRightSize, -1);
                    setIconRight(iconRight);
                    setIconRightSize(iconRightSize);

                    float spaceLeft = ta.getDimension(R.styleable.IconText_it_spaceLeft, -1);
                    float spaceRight = ta.getDimension(R.styleable.IconText_it_spaceRight, -1);
                    setSpaceLeft(spaceLeft);
                    setSpaceRight(spaceRight);

                    float paddingLeft = ta.getDimension(R.styleable.IconText_it_paddingLeft, -1);
                    float paddingRight = ta.getDimension(R.styleable.IconText_it_paddingRight, -1);
                    setPaddingLeft(paddingLeft);
                    setPaddingRight(paddingRight);

                    ColorStateList iconRightColor = ta.getColorStateList(R.styleable.IconText_it_iconRightColor);
                    ColorStateList iconLeftColor = ta.getColorStateList(R.styleable.IconText_it_iconLeftColor);
